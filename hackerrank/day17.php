...
There are TT lines of output, where each line contains the result of np as calculated by your Calculator class' power method.
...
T2: Both inputs (−1 and −2) are negative, so power throws an exception and n and p should be non-negativen and p should be non-negative is printed.
T3: One of the inputs (−1) is negative, so power throws an exception and n and p should be non-negativen and p should be non-negative is printed.
    */
class Calculator{
