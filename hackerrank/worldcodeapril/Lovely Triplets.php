...
There are exactly P=3P=3 lovely triplets in this graph: {1,3,5}{1,3,5}, {2,4,6}{2,4,6}, and {2,6,7}{2,6,7}.

https://s3.amazonaws.com/hr-challenge-images/18055/1456578497-18944ac196-tripletex.png

Observe that each node in a lovely triplet is Q=2Q=2 edges away from the other nodes composing the lovely triplet.
 *
 */

$handle = fopen ("php://stdin","r");
fscanf($handle,"%d %d",$P,$Q);